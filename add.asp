...
set updateRs=Server.CreateObject("ADODB.recordset")
editSQL = "UPDATE "&prefixoTabela&"reservas SET nome"&n&"='"& nome &"', email"&n&"='"& email &"', telefone"&n&"='"& telefone &"', end"&n&"='"& endereco &"', sexo"&n&"='"& sexo &"', atendimento"&n&"='"& atendimento &"', disp"&n&"='n' WHERE id="&id
updateRs.open editSQL, Conexao
...
if email<>"" then
	...
	param.Update
		...
		message.Bcc = "ga@drgustavoabreu.com.br"
		message.To = strTo
...
response.redirect("consultas_confirma.asp?n="&nome&"&e="&email&"&t="&telefone&"&en="&endereco&"&s="&sexo&"&a="&atendimento&"&ds="&diaSemana&"&dia="&dia&"&h="&horario)
%>